...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(org.springframework.http.HttpMethod.POST, "/servicos").hasRole("MASTER")
                        .requestMatchers(org.springframework.http.HttpMethod.PUT, "/servicos/**").hasRole("MASTER")
                        .requestMatchers(org.springframework.http.HttpMethod.DELETE, "/servicos/**").hasRole("MASTER")
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("http://localhost:4200", "https://barbeariatrindade.vercel.app"));
